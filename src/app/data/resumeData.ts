...
export const resumeData = {
    hero: {
      ...
      summary: [
        ...
        ". Имею опыт тимлидства в проектной деятельности и разработке backend-сервисов на ",
    ...
    skills: {
      ...
      experience: [
        ...
        },
        {
          ...
          diploma: "/diplom-kafedra-ck.pdf" // Added diploma property
        }
      ],
      projects: {
        ...
        details: [
          ...
          },
          {
            ...
            content: "Для каждого этапа обучения использовался планировщик <strong>OneCycleLR</strong>, который динамически изменяал learning rate для более быстрой и стабильной сходимости. Также был внедрен механизм <strong>Early Stopping</strong> для предотвращения переобучения."
          }
        ]
      },
      education: {
      ...
      contact: {
        ...
        links: [
          ...
          {
            type: 'github',
            label: "GitHub: shorins",
            href: "https://github.com/shorins"
          },
          {
            type: 'kaggle',
